...
async function main() {
    ...
    const allProducts = [
        ...
        },
        {
            ...
            category: "iPhones Seminovos",
            specs: 'Tela Super Retina XDR de 6,1", chip A16 Bionic, câmera dupla de 48MP, 256GB de armazenamento',
            isNew: false,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            category: "iPhones Seminovos",
            specs: 'Tela Super Retina XDR de 6,7", chip A16 Bionic, câmera tripla de 48MP, 512GB de armazenamento',
            isNew: false,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            category: "iPhones Seminovos",
            specs: 'Tela Super Retina XDR de 6,7", chip A16 Bionic, câmera tripla de 48MP, 256GB de armazenamento',
            isNew: false,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            category: "iPhones Seminovos",
            specs: 'Tela Super Retina XDR de 6,1", chip A14 Bionic, câmera tripla de 12MP, 128GB de armazenamento',
            isNew: false,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela ~6.3", Chip A18 Pro, Câmera Ultra Wide 48MP, Zoom Óptico 5x, Wi-Fi 7, Botão de Captura, Bateria ~3355 mAh (Rumor)',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela Super Retina XDR 6.7", Chip A17 Pro, Câmera Tripla 48MP, USB-C (USB 3), Titânio, Botão de Ação',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela 6.7", Chip A18, Câmera 48MP Fusion, Botão de Ação, Botão de Captura, USB-C (Rumor/Preliminar)',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela 6.1", Chip A18, Câmera 48MP Fusion, Botão de Ação, Botão de Captura, USB-C (Rumor/Preliminar)',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela Super Retina XDR 6.1", Chip A16 Bionic, Câmera Dupla 48MP, Dynamic Island, USB-C (USB 2)',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela Super Retina XDR 6.1", Chip A15 Bionic (GPU 5-core), Câmera Dupla 12MP, Detecção de Acidente',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela Super Retina XDR 6.1", Chip A15 Bionic (GPU 4-core), Câmera Dupla 12MP, Modo Cinema',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela Liquid Retina HD LCD 6.1", Chip A13 Bionic, Câmera Dupla 12MP, Modo Noite',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "iPhones Novos",
            specs: 'Tela Super Retina XDR OLED 6.1", Chip A14 Bionic, Câmera Dupla 12MP, 5G, Ceramic Shield',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina XDR 14.2", Chip M4 Max (14/16-core CPU, 32/40-core GPU), 3x Thunderbolt 5, HDMI, SDXC, MagSafe 3, Wi-Fi 6E',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina XDR 16.2", Chip M4 Pro (14-core CPU, 20-core GPU), 3x Thunderbolt 5, HDMI, SDXC, MagSafe 3, Wi-Fi 6E',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina XDR 14.2", Chip M4 (10-core CPU, 10-core GPU), 3x Thunderbolt 4, HDMI, SDXC, MagSafe 3, Wi-Fi 6E',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina XDR 14.2", Chip M4 Pro (14-core CPU, 20-core GPU), 3x Thunderbolt 5, HDMI, SDXC, MagSafe 3, Wi-Fi 6E',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina 15.3", Chip M3 (8-core CPU, 10-core GPU), 2x Thunderbolt / USB 4, MagSafe 3, Wi-Fi 6E',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina 13.6", Chip M3 (8-core CPU, 10-core GPU), 2x Thunderbolt / USB 4, MagSafe 3, Wi-Fi 6E',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
        ...
        },
        {
            ...
            details: "aparelho novo",
            category: "Macbooks",
            specs: 'Tela Liquid Retina 13.6", Chip M2 (8-core CPU, 8-core GPU), 2x Thunderbolt / USB 4, MagSafe 3, Wi-Fi 6',
            isNew: true,
            realImages: [],
            userId: user.id,
        },
    ...
    for (const productData of allProducts) {
        try {
            ...
            console.log(`✅ ${product.model} - ${product.storage} (${product.category})`);
            createdCount++;
        }
        catch (error) {
    ...
    console.log(`🎉 Seed concluído! ${createdCount} produtos criados com sucesso!`);
}
main()
    .catch((e) => {
...
//# sourceMappingURL=seed-complete2.js.map