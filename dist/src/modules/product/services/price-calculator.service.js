...
let PriceCalculatorService = class PriceCalculatorService {
    ...
    async calculatePrices(data) {
        ...
        const installmentPriceValue = pixPriceValue / config.installmentDiv1 / config.installmentDiv2;
    ...
    getFreightByCategory(category, defaultFreight = 100) {
        if (!category)
    ...
    async calculateProductPrices(cost, freight = 100, configName = "default") {
